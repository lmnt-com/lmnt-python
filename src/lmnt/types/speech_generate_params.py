# Generated by carbonsteel. DO NOT EDIT. Source: openapi.yaml#/paths/v1/ai/speech/bytes/post
...
class SpeechGenerateParams(TypedDict, total=False):
  ...
  """The desired output format of the audio.
    ...
    For non-streamable formats, all speech will be generated before encoding.
  ...
  """The model to use for speech generation.
    ...
    Learn more about models [here](https://docs.lmnt.com/models/overview).
    """
