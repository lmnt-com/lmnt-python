...
from .resources import speech, voices, accounts
...
class Lmnt(SyncAPIClient):
    speech: speech.SpeechResource
    accounts: accounts.AccountsResource
    voices: voices.VoicesResource
    with_raw_response: LmntWithRawResponse
    with_streaming_response: LmntWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        This automatically infers the `api_key` argument from the `LMNT_API_KEY` environment variable if it is not provided.
        """
        if api_key is None:
        ...
        if base_url is None:
            base_url = os.environ.get("LMNT_BASE_URL")
        if base_url is None:
        ...
        self.with_raw_response = LmntWithRawResponse(self)
        self.with_streaming_response = LmntWithStreamedResponse(self)
...
class AsyncLmnt(AsyncAPIClient):
    speech: speech.AsyncSpeechResource
    accounts: accounts.AsyncAccountsResource
    voices: voices.AsyncVoicesResource
    with_raw_response: AsyncLmntWithRawResponse
    with_streaming_response: AsyncLmntWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        self.with_raw_response = AsyncLmntWithRawResponse(self)
        self.with_streaming_response = AsyncLmntWithStreamedResponse(self)
...
class LmntWithRawResponse:
    def __init__(self, client: Lmnt) -> None:
...
class AsyncLmntWithRawResponse:
    def __init__(self, client: AsyncLmnt) -> None:
...
class LmntWithStreamedResponse:
    def __init__(self, client: Lmnt) -> None:
...
class AsyncLmntWithStreamedResponse:
    def __init__(self, client: AsyncLmnt) -> None:
